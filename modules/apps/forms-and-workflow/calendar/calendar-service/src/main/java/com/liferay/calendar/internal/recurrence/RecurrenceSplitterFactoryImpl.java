 ...
 */
@Component(service = RecurrenceSplitterFactory.class)
public class RecurrenceSplitterFactoryImpl
	implements RecurrenceSplitterFactory {
	...
	public RecurrenceSplitter getRecurrenceSplitter(
		...
		return new RecurrenceSplitterImpl(
