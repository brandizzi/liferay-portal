...
public class DLFolderModelQueryPreFilterContributor
	...
	public void contribute(
		...
		//added from DLFolderIndexer.postProcessContextBooleanFilter()
	...
	protected void addHelperFilters(BooleanFilter fullQueryBooleanFilter,
		...
		//basically added always, has to be here for class name
		modelQueryPreFilterContributorHelper.addPermissionFilter(
			fullQueryBooleanFilter, DLFolder.class.getName(), searchContext);

		//added because setStagingAware was not set to false in DLFolderIndexer
