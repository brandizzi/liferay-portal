...
public class IndexerClausesTest {
	...
	public void testBaseIndexer() throws Exception {
		...
		assertSearch(
			searchRequestBuilder, _TITLE_EN_US, Arrays.asList("alpha"));
	}
	...
	public void testDefaultIndexer() throws Exception {
		...
		assertSearch(
			searchRequestBuilder, Field.USER_NAME, Arrays.asList("gama omega"));
	}
	...
	public void testFacetedSearcher() throws Exception {
		...
		assertSearch(
			searchRequestBuilder, Field.USER_NAME,
