...
public class MultiLanguageSearchTest {
	...
	public void testMultiLanguageArticleContent() throws Exception {
		String searchTerm = "content"; // Really?
	...
	public void testMultiLanguageArticleDescription() throws Exception {
		String searchTerm = "description"; // Hm
	...
	protected void _addExpectedLocalizedValuesMaps(
	...
	protected JournalArticle addJournalArticle(
		...
		_journalArticlesMap.put(journalArticle.getArticleId(), journalArticle);
	...
	protected void addJournalArticlesExpectedResults() throws Exception {
		...
		_addExpectedLocalizedValuesMaps(
	...
	private final Map<String, JournalArticle> _journalArticlesMap =
		new HashMap<>(3);
