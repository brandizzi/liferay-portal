 ...
 * @author Lino Alves
 */
public interface FederatedSearchResultsPortletPreferences {

	public static final String PREFERENCE_KEY_FEDERATED_SEARCH_SOURCE_NAME =
		"federatedSearchSourceName";

	public static final String PREFERENCE_KEY_FEDERATED_SEARCH_DISPLAY_STYLE =
		"federatedSearchDisplayStyle";
