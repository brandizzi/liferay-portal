...
<portlet:actionURL name="createResultsRankingEntry" var="createResultsRankingEntryURL">
	<portlet:param name="mvcRenderCommandName" value="createResultsRankingEntry" />
</portlet:actionURL>

<liferay-frontend:edit-form action="<%= createResultsRankingEntryURL %>">
