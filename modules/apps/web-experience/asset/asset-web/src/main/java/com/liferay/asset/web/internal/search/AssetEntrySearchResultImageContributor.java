...
package com.liferay.asset.web.internal.search;
...
public class AssetEntrySearchResultImageContributor
	...
	public void contribute(SearchResultImage searchResultImage) {
		...
		if (className.equals(AssetEntry.class.getName())) {
			searchResultImage.setIcon("web-content");
		}
	}
