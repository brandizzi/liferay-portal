...
import com.liferay.portal.search.facet.geolocation.GeoDistanceFacetFactory;
...
public class GeoDistanceSearchFacet extends BaseJSPSearchFacet {
	...
	protected FacetFactory getFacetFactory() {
		return geoDistanceFacetFactory;
	}
	...
	@Reference
	protected GeoDistanceFacetFactory geoDistanceFacetFactory;
