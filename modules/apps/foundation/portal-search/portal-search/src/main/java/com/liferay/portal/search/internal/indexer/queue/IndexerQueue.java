...
public class IndexerQueue {
	...
	public boolean isEmpty() {
		return _indexerTokens.isEmpty();
	}

	public void put(IndexerToken indexerTokenImpl) {
		_indexerTokens.add(indexerTokenImpl);
	}

	public List<IndexerToken> take(int count) {
	...
	private final List<IndexerToken> _indexerTokens = new ArrayList<>();
