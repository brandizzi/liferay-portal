...
public class GeoDistanceRangeFilterTranslatorImpl
	...
	public QueryBuilder translate(
		...
		GeoPoint geoPoint = new GeoPoint(pinGeoLocationPoint.getLatitude(),
		...
		//no lower bound any more. ranges can be acquired through pagination or aggregation instead
