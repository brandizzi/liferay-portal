...
public class ElasticsearchSearchEngine extends BaseSearchEngine {
	...
	public void initialize(long companyId) {
		...
		_log.error("LPS-100272 " + clazz.getName() + ": initializing company " + companyId);
		...
		_log.error(
			StringBundler.concat(
				"LPS-100272 " + clazz.getName(), ": company ", companyId, "initialized"));
	}
	...
	public void removeCompany(long companyId) {
		...
		try {
			_log.error("LPS-100272 " + clazz.getName() + ": removing company " + companyId);
