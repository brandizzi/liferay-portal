...
public class GetDocumentRequestExecutorImpl
	...
	public GetDocumentResponse execute(GetDocumentRequest getDocumentRequest) {
		GetRequestBuilder getRequestBuilder = _getRequestTranslator.translate(
			getDocumentRequest);
	...
	@Reference(target = "(search.engine.impl=Elasticsearch)", unbind = "-")
	protected void setGetRequestTranslator(
		GetRequestTranslator getRequestTranslator) {

		_getRequestTranslator = getRequestTranslator;
	}
	...
	private GetRequestTranslator _getRequestTranslator;
