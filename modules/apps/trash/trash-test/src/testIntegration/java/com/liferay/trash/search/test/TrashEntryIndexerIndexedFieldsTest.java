...
public class TrashEntryIndexerIndexedFieldsTest {
	...
	protected Map<String, String> populateExpectedFieldValues(
		...
		String mymeType = fileEntry.getMimeType();

		String formattedMymeType = mymeType.replaceAll("/", "_");
		...
		map.put("mimeType", formattedMymeType);
		map.put("mimeType_String_sortable", formattedMymeType);
