 ...
 */
@Component(service = RankingIndexNameFactory.class)
public class RankingIndexNameFactoryImpl implements RankingIndexNameFactory {
	...
	private static class RankingIndexNameImpl implements RankingIndexName {
